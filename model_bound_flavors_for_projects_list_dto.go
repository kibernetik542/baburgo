...
type BoundFlavorsForProjectsListDto struct {
	...
	HasLSpotPrice *bool `json:"hasLSpotPrice,omitempty"`
	HasWSpotPrice *bool `json:"hasWSpotPrice,omitempty"`
...
// GetHasLSpotPrice returns the HasLSpotPrice field value if set, zero value otherwise.
func (o *BoundFlavorsForProjectsListDto) GetHasLSpotPrice() bool {
	if o == nil || IsNil(o.HasLSpotPrice) {
		var ret bool
		return ret
	}
	return *o.HasLSpotPrice
}

// GetHasLSpotPriceOk returns a tuple with the HasLSpotPrice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BoundFlavorsForProjectsListDto) GetHasLSpotPriceOk() (*bool, bool) {
	if o == nil || IsNil(o.HasLSpotPrice) {
		return nil, false
	}
	return o.HasLSpotPrice, true
}
...
// SetHasLSpotPrice gets a reference to the given bool and assigns it to the HasLSpotPrice field.
func (o *BoundFlavorsForProjectsListDto) SetHasLSpotPrice(v bool) {
	o.HasLSpotPrice = &v
}

// GetHasWSpotPrice returns the HasWSpotPrice field value if set, zero value otherwise.
func (o *BoundFlavorsForProjectsListDto) GetHasWSpotPrice() bool {
	if o == nil || IsNil(o.HasWSpotPrice) {
		var ret bool
		return ret
	}
	return *o.HasWSpotPrice
}

// GetHasWSpotPriceOk returns a tuple with the HasWSpotPrice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BoundFlavorsForProjectsListDto) GetHasWSpotPriceOk() (*bool, bool) {
	if o == nil || IsNil(o.HasWSpotPrice) {
		return nil, false
	}
	return o.HasWSpotPrice, true
}
...
// SetHasWSpotPrice gets a reference to the given bool and assigns it to the HasWSpotPrice field.
...
func (o BoundFlavorsForProjectsListDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HasLSpotPrice) {
		toSerialize["hasLSpotPrice"] = o.HasLSpotPrice
	}
	if !IsNil(o.HasWSpotPrice) {
		toSerialize["hasWSpotPrice"] = o.HasWSpotPrice
	}
