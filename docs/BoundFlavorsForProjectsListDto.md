...
**HasLSpotPrice** | Pointer to **bool** |  | [optional] 
**HasWSpotPrice** | Pointer to **bool** |  | [optional] 
...
`func (o *BoundFlavorsForProjectsListDto) GetHasLSpotPrice() bool`

GetHasLSpotPrice returns the HasLSpotPrice field if non-nil, zero value otherwise.

### GetHasLSpotPriceOk

`func (o *BoundFlavorsForProjectsListDto) GetHasLSpotPriceOk() (*bool, bool)`

GetHasLSpotPriceOk returns a tuple with the HasLSpotPrice field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetHasLSpotPrice

`func (o *BoundFlavorsForProjectsListDto) SetHasLSpotPrice(v bool)`

SetHasLSpotPrice sets HasLSpotPrice field to given value.

### HasHasLSpotPrice

`func (o *BoundFlavorsForProjectsListDto) HasHasLSpotPrice() bool`

HasHasLSpotPrice returns a boolean if a field has been set.

### GetHasWSpotPrice

`func (o *BoundFlavorsForProjectsListDto) GetHasWSpotPrice() bool`

GetHasWSpotPrice returns the HasWSpotPrice field if non-nil, zero value otherwise.

### GetHasWSpotPriceOk

`func (o *BoundFlavorsForProjectsListDto) GetHasWSpotPriceOk() (*bool, bool)`

GetHasWSpotPriceOk returns a tuple with the HasWSpotPrice field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetHasWSpotPrice

`func (o *BoundFlavorsForProjectsListDto) SetHasWSpotPrice(v bool)`

SetHasWSpotPrice sets HasWSpotPrice field to given value.

### HasHasWSpotPrice

`func (o *BoundFlavorsForProjectsListDto) HasHasWSpotPrice() bool`

HasHasWSpotPrice returns a boolean if a field has been set.
